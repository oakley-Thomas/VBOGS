...
posed RGB frames prepared in a COLMAP-style layout. Stereo is not used as a
training signal for this stage; dataset-specific depth or LiDAR observations
are used later to build the 6D point cloud.
