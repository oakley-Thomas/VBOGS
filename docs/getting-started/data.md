...
| Training images | Uses the left perspective camera frames from `image_00/data_rect/`. | Decodes the selected NCore camera sensor, default `camera_front_wide_120fov`. |
